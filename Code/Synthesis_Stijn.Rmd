...
predict_synth_or_true = function(data, model) {
  ...
  result = data.frame(true_value, predicted_value = factor(predicted_values, levels = c(0, 1)))
...
## 5e & 5f. For each of the m imputed sets, combine half of the imputed set randomly with half of the true set & run a prediction model that predicts syn or true
