...
- c. Calculating the sampling variance of the statistics and parameters by means of the bootstrap
- d. Calculating the sampling variance of the model parameters by means of pooling rules. 
- e. Calculating the 95% coverage rates of the parameters and statistics (bootstrap and pooling)
